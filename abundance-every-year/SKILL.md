...
description: 专业的A股市场评论撰写工具，基于真实行情数据撰写"[品牌名称]"风格的市场分析文章，涵盖大盘行情、板块表现、资金流向、技术面和基本面分析
dependency:
  python:
    - akshare>=1.18.0
    - pandas>=1.3.0
...
3. **撰写市场评论（初稿）**
   - **严格遵循"[品牌名称]"创作风格**，参考 [references/创作风格.md](references/创作风格.md) 中的风格指南
   - **必须包含完整的标题格式**：
...
5. **文案润色（根据微观风格特征）**
   - **润色目标**：严格按照 [references/创作风格_微观特征.md](references/创作风格_微观特征.md) 中的微观风格特征进行润色，确保体现"[品牌名称]"真实的跨文本写作风格
   - **润色原则（必须严格遵守）**：
...
- 领域参考：
  - [references/创作风格.md](references/创作风格.md) - 投顾评论创作风格指南（格式与结构指南）
  - [references/创作风格_微观特征.md](references/创作风格_微观特征.md) - 微观风格特征指南（句式、词汇、修辞、节奏等）
...
- **风格优先**：
  * 初稿撰写：必须严格遵循 [references/创作风格.md](references/创作风格.md) 中的6段式结构和语言风格
  * 文案润色：必须严格按照 [references/创作风格_微观特征.md](references/创作风格_微观特征.md) 中的微观风格特征进行润色
